...
public class ScorePanel : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // for (int i = 0; i < _donneesScore.LesDonneesTableau.Count; i++) // Instancie les panneaux joueurs avec leurs noms et scores
        // {
        //     GameObject panneauJoueur = Instantiate(_singlePanelScore, transform.position, Quaternion.identity);
    ...
    public void WriteDownCurrentScore()
    {
